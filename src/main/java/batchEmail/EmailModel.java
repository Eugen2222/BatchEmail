...
public class EmailModel {
	 ...
	 */
		...
		// TODO Auto-generated constructor stub
			...
			public EmailModel(String subject,String content,Properties p,String attachmentLocat, String attachmentName)
			{	
				this.to=new ArrayList<InternetAddress>();
				this.content = content;
				this.p = p;
			...
			public void run() throws GeneralSecurityException, UnsupportedEncodingException, MessagingException  {
